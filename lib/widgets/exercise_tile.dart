...
import 'package:weightlifting.cc/pages/add_workout.dart';
...
class _ExerciseTileState extends State<ExerciseTile> {
  ...
  Widget _nextSetControls(BuildContext context) {
    return ButtonBar(
      ...
      child: ExpansionPanelList(
        ...
        children: [
          ExpansionPanel(
            ...
            body: Column(
                children: _sets(context) + <Widget>[_nextSetControls(context)]),
          )
        ],
      ),
    );
